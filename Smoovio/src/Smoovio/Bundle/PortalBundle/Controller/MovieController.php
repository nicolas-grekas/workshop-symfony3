...
use Smoovio\Bundle\CoreBundle\Repository\GenreRepository;
use Smoovio\Bundle\CoreBundle\Repository\MovieRepository;
...
class MovieController extends Controller
{
    ...
    {
        $movie = $this->getMovieRepository()->getRandomMovie();

        return $this->render('SmoovioPortalBundle:Movie:movie.html.twig', [
            'movie' => $movie,
        ]);
    }
     ...
     * @throws NotFoundHttpException
     */
    public function listByActorAction()
    {
